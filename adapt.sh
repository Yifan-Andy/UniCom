...
# run cora from DBLP
python3 train.py \
    --dataset cora --batch_size 2708 --hidden_dim 512 --hops 5 \
    --n_heads 8 --n_layers 1 --pe_dim 3 --peak_lr 0.001 --end_lr 0.0001 --weight_decay 5e-4 --epochs 30 \
    --n_pos_neg_sample 3 --cohesive_subgraphs --alpha 0.1 \
    --pretrain_dataset dblp --pretrain_dim 1642 \
    --embedding_path ./checkpoints/prompt_result/ --device 1 \
...
# run fusion
python3 fusion.py --dataset cora
